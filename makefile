...
CXX_INCL=$(INCL:%=-I%)
CXX_FLAGS= -mmacosx-version-min=10.7 -isysroot $(SDK_LOCATION) -dynamiclib -std=c++17 -lc++ -DCC_TARGET_OS_MAC -lGDML -lCacao -LCacao/static -dynamiclib -lSystem -lstdc++ -g Cacao/include/Cacao.cpp -Wno-deprecated -lSystem -static -framework Foundation -framework CoreServices 


main: dist
	@echo "Building project..."
	@$(CXX) $(CXX_INCL) $(CXX_FLAGS) $(CXX_EXTRA) rpc.cpp discord-rpc/lib/libdiscord-rpc.a -o $(OUTPUT)
	@echo "Finished"
dist:
	mkdir dist
clean: 
